...
class WorkoutSet {
    ...
    func addInSet() {
        ...
        //Set1
        playlist.append(Set(time: "0:50", cad: "Fast", zone: "150% FTP"))//1
        playlist.append(Set(time: "0:10", cad: "0 Cadence", zone: "Zone 2"))
        
        playlist.append(Set(time: "0:50", cad: "Fast", zone: "150% FTP"))//2
        playlist.append(Set(time: "0:10", cad: "0 Cadence", zone: "Zone 2"))
        
        playlist.append(Set(time: "0:50", cad: "Fast", zone: "150% FTP"))//3
        playlist.append(Set(time: "0:10", cad: "0 Cadence", zone: "Zone 2"))

        playlist.append(Set(time: "0:50", cad: "Fast", zone: "150% FTP"))//4
        playlist.append(Set(time: "0:10", cad: "0 Cadence", zone: "Zone 2"))
        
        playlist.append(Set(time: "0:50", cad: "Fast", zone: "150% FTP"))//5
        playlist.append(Set(time: "0:10", cad: "0 Cadence", zone: "Zone 2"))
        playlist.append(Set(time: "2:00", cad: "Recovery", zone: "Zone 1/2"))
        ...
        //Set 5
        playlist.append(Set(time: "6:00", cad: "Tempo", zone: "Zone 3"))//1
        playlist.append(Set(time: "4:00", cad: "Tempo", zone: "Low Zone 4"))
        playlist.append(Set(time: "3:00", cad: "Tempo", zone: "Mid Zone 4"))//2
        playlist.append(Set(time: "2:00", cad: "Tempo", zone: "High Zone 4"))
        playlist.append(Set(time: "1:00", cad: "Tempo", zone: "Max"))//3
        playlist.append(Set(time: "5:00", cad: "Recovery", zone: "Zone 1/2"))
        ...
        playlist.append(Set(time: "13:00", cad: "Finished!", zone: "Zone 2/3"))
